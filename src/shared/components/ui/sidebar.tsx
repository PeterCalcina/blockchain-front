...
>(
  (
    ...
    // Tu lógica para collapsible="none" está bien, la mantenemos
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Ya no necesitamos el div de relleno, el grid se encarga de ello */}
        <div
          className={cn(
            "duration-200 h-svh flex w-full flex-col bg-sidebar transition-[width] ease-linear",
            "group-data-[collapsible=offcanvas]:w-0",
            "group-data-[side=right]:order-last",
            // Aseguramos que el ancho se maneje aquí, o por el grid
